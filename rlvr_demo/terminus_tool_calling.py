...
def get_terminal_synthetic_task_dataset(*args: Any, **kwargs: Any) -> Any:
    from rlvr_demo.terminal_task_grpo import get_terminal_synthetic_task_dataset as _loader
...
def __getattr__(name: str) -> Any:
    if name == "TerminusToolTerminalGRPOConfig":
        from rlvr_demo.terminal_task_grpo import TerminalTaskGRPOConfig
...
def main() -> None:
    ...
    smoke.add_argument("--output-dir", type=Path, default=Path("/wbl-fast/usrs/ee/teacher-answer-rl/areal_runs/terminus-tool-calling/deepseek_smoke"))
    smoke.add_argument("--results-output", type=Path, default=Path("/wbl-fast/usrs/ee/teacher-answer-rl/areal_runs/terminus-tool-calling/deepseek_smoke/results.json"))
