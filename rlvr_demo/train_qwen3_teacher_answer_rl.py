"""AReaL teacher-answer RL training entry point for Qwen3 math experiments."""
...
def main(args: list[str]) -> None:
    ...
    with PPOTrainer(config, train_dataset=train_dataset, valid_dataset=valid_dataset) as trainer:
        trainer.train(
            workflow="rlvr_demo.teacher_answer_rl.TeacherAnswerRLWorkflow",
            workflow_kwargs=workflow_kwargs,
            eval_workflow="rlvr_demo.teacher_answer_rl.TeacherAnswerRLWorkflow",
