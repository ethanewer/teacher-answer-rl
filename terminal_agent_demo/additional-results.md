...
timestamps or the validated recipe budget. Scores are true comparable evaluator
scores: task-scoped eval repairs and evaluator-side task solutions are disabled.
...
| Domain-general likelihood TA-RL | 0.20h | README short selected checkpoint | 27/100 |
