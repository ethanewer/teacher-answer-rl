...
def main(args: list[str]) -> None:
    ...
    with PPOTrainer(
        ...
        trainer.train(
            workflow="terminal_agent_demo.terminus_tool_calling.TerminusToolTerminalGRPOWorkflow",
            workflow_kwargs=workflow_kwargs,
            eval_workflow="terminal_agent_demo.terminus_tool_calling.TerminusToolTerminalGRPOWorkflow",
